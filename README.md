...
![EightShapes contrast grid](documentation/wireframes/contrast-comparison.png)
...
![Wave report photo](documentation/wireframes/wave.png)
...
* Text taken from owners current site. [Current site](http://yeoldefishandchips.co.uk/)
* The reference material on HTML and CSS provided by [W3 Schools](https://www.w3schools.com/default.asp) was utilized to implement and help with understanding regarding flexbox and grid and as general reference material for other areas.
* Icons used for the various links on the site were taken from [Font Awesome](https://fontawesome.com/)

### Media  

* The image used for hero image on the main banner on each page was provided royalty-free through [Pexels.com](https://www.pexels.com/)
* The Favicon, links, and meta code were generated by [Fav icon generator](https://favicon.io/)
* The Images of the shop were taken from the owner themself.
