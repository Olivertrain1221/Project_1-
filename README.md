...
* The reference material on HTML and CSS provided by w3schools.com was utilised to implement and help with understanding regarding flexbox and grid and as general reference material for other areas.
...
* The Images of the shop were taken from the owners current site.
